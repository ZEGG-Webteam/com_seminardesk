  ...
  <div class="sd-facilitatorlist">
    <?php foreach($this->facilitators->getItems() as $facilitator) : ?>
      <div class="sd-facilitator" 
        ...
        <a href="<?= $facilitator->detailsUrl ?>" itemprop="url" class="<?= $facilitator->cssClasses ?>">
          <div class="sd-facilitator-name">
            <h4><?= $facilitator->title ?> <span itemprop="givenName"><?= $facilitator->firstName ?></span> <span itemprop="familyName"><?= $facilitator->lastName ?></span></h4>
          </div>
        </a>
