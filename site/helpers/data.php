...
//      self::LABELS_FESTIVALS_ID, 
  ...
  public static function cleanupStyles($text) {
    // Remove style attributes from all tags except img, table, th and td,
    // which should keep their styles (e.g. for layout / column widths).
   ...
   */
  public static function getStructuredData($event) {
    if (!$event->dates) {
...
//      }
    ...
    $event->structuredData = self::getStructuredData($event);
  }
